         ...
         for file in os.listdir(folderpath):
            if file.endswith('.json') and file !="Overview.json": #just coursex.json
             ...
             with open(filename, encoding="utf8") as f:
                ...
                clng = len(core)
                i = 0
                translatedTitle= json_translate.translate(title, dest='ar').text
                while (i < clng):
                   c = core[i]
                   if c == '#':
                      ...
                      #append new Headline
                      translatedHeadline=json_translate.translate(headline, dest='ar').text
                      ...
                      if (c == '-' and (i + 1)< clng):
                         if(core[i + 1] == '>'): #element list spotted !
                            ...
                            #append new Headline
                            translatedList_el = json_translate.translate(list_el, dest='ar')
