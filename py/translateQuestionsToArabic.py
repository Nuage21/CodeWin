...
if __name__ == "__main__":
 ...
 filename="../data/data/Questions.json"
 i=0
 with open(filename, encoding="utf8") as f:
     ...
     while (i<len(questions)):
         ...
         while (k<len(qs['propositions'])): #to translate the propositions
             ...
             translatedProposition = json_translate.translate(proposition, dest='ar').text
             proposition=translatedProposition
             k=k+1
         note=qs["note"]
         translatedNote=json_translate.translate(note, dest='ar').text
         note=translatedNote
         i=i+1
     filename2="../data/data-arabic/Questions.json"
