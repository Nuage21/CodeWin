...
/*                             using
	...
	MediaPlayer audio = new MediaPlayer("D:/les programme java new eclips/sound/correct.wav");
		audio.play();
*/
...
public class MediaPlayer implements Runnable {
    ...
    public static String correctSoundFilename = "audio\\correct.wav";
    public static String wrongSoundFilename = "audio\\wrong.wav";
    public static String modifSoundFilename = "audio\\modif.wav";

    public static int CORRECT_SOUND = 0x00;
    public static int WRONG_SOUND = 0x01;
    public static int MODIF_SOUND = 0x02;

    public static void playAnswerReaction(int soundType) {

    	String sound_file = correctSoundFilename;

    	if(soundType == WRONG_SOUND)
    		sound_file = wrongSoundFilename;
    	else if(soundType == MODIF_SOUND)
    		sound_file = modifSoundFilename;

    	final String final_sf = sound_file;
        Task<Void> player = new Task<Void>() {
            @Override
            protected Void call() throws Exception {
                MediaPlayer mp = new MediaPlayer(Settings.projectPath + final_sf);
